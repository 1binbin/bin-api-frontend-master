...
/** listInterfaceInfoVOByPage POST /api/interfaceInfo/one/list/page/vo */
export async function listInterfaceInfoVOByPageForOneUsingPOST(
    body: API.InterfaceInfoQueryRequest,
    options?: { [key: string]: any },
) {
    return request<API.BaseResponsePageInterfaceInfoVO_>('/api/interfaceInfo/one/list/page/vo', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
