...
/** userRegister POST /api/user/forgetPassword */
export async function userForgetPasswordUsingPOST(
    body: API.UserForgetPasswordRequest,
    options?: { [key: string]: any },
) {
    return request<API.BaseResponseLong_>('/api/user/forgetPassword', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
